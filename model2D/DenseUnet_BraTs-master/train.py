...
# IMG_PATH = glob(r'H:\_proj\BrainTumorSegmentation-main\Brats2018FoulModel2D\trainImage\*')
# MASK_PATH = glob(r'H:\_proj\BrainTumorSegmentation-main\Brats2018FoulModel2D\trainMask\*')
